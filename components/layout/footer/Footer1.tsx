            ...
            <div className="row align-items-center">
              <div className="col-md-4 text-center text-md-start">
                <Link className="d-inline-block" href="/">
                  <img alt="Travila" src="/assets/imgs/template/hitravel.png" />
                </Link>
              </div>
              <div className="col-md-8 text-center text-md-end">
                <div className="d-flex align-items-center justify-content-center justify-content-md-end ">
                  <Link
                    ...
                    href="tel:+905326691107"
                  >
                    {t("need")}
                  </Link>
                  <Link
                    className="text-xl phone-support"
                    href="tel:+905326691107"
                  >
                    {t("phone")}
                  </Link>
          ...
          <div className="row">
              ...
              <div className="mt-20 mb-20">
                ...
                <div className="box-socials-footer">
                  ...
                  <Link
                    ...
                    href="https://www.facebook.com/hianatolia"
                  >
                    <svg
                      width={20}
                      height={20}
                  ...
                  <Link
                    ...
                    href="www.youtube.com/@HİAnatoliaTravelAgency"
                  >
                    <svg
                      width={21}
                      height={15}
            ...
            <div className="col-md-2 col-xs-6 footer-2">
              ...
              <ul className="menu-footer">
                <li>
                  <Link href="/about">Hi Travel</Link>
                </li>
                <li>
                  <Link href="/privacy">{t("privacy")}</Link>
                </li>
                <li>
                  <Link href="/term">{t("term")}</Link>
                </li>
                <li>
