          ...
          <section className="box-section box-breadcrumb">
            <div className="container">
              <ul className="breadcrumbs">
                ...
                <li>
                  {" "}
                  <span className="text-breadcrumb">{t("refund")}</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="container">
              ...
              <div className="box-mw-824">
                <div className="box-detail-info">
                  ...
                  <p>
                    <strong>{t("title1")}:</strong> {t("desc1")}
                  </p>
                  ...
                  <p>
                    <strong>{t("title3")}:</strong> {t("desc3")}
                  </p>

                  <p>
                    <strong>{t("title4")}:</strong> {t("desc4")}
                  </p>
                  ...
                  <p>
                    <strong>{t("title5")}:</strong> {t("desc5")}
                  </p>

                  <p>
                    <strong>{t("title6")}:</strong>
                    {t("desc6")}
                  </p>

                  <p>
                    <strong> {t("title7")}:</strong> {t("desc7")}
                  </p>

                  <p>
                    <strong>{t("title8")}:</strong> {t("desc8")}
                  </p>

                  <p>
                    <strong>{t("title9")}:</strong> {t("desc9")}
                  </p>
                </div>
                <div className="box-share-us">
                  <div className="d-flex align-items-center box-socials-footer-cover mb-25"></div>
