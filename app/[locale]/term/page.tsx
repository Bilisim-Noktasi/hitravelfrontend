          ...
          <section className="box-section box-breadcrumb">
            <div className="container">
              <ul className="breadcrumbs">
                ...
                <li>
                  {" "}
                  <span className="text-breadcrumb mt-[-10px]">{t("gizlilik")}</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="container">
              ...
              <div className="box-mw-824">
                <div className="box-detail-info">
                  ...
                  <p>
                  <strong>2. {t("title1")}:</strong>{t("description1")}
                  </p>
                  <p>
                  <strong>3. {t("title2")}:</strong>{t("description2")}
                  </p>
                  <p>
                  <strong>4. {t("title3")}:</strong>{t("description3")}
                  </p>
                  <p>
                  <strong>5. {t("title4")}:</strong>{t("description4")}
                  </p>
                  <p>
                  <strong>6. {t("title5")}:</strong>{t("description5")}
                  </p>
                  <p>
                  <strong>6. {t("title6")}:</strong>{t("description6")}
                  </p>
                </div>
