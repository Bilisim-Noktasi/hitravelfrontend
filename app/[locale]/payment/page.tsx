...
export default function Payment() {
  ...
  const [showConfirmModal, setShowConfirmModal] = useState(false); // Onay modal durumu
  ...
  const handleProcessPayment = async (method: number) => {
    if (!bookingId) {
      console.error("Rezervasyon ID bulunamadı.");
      return;
    }
    ...
    // TypeScript'e bookingId'nin null olmadığını garanti ediyoruz
  ...
  // Modal onay butonuna basıldığında çağrılacak fonksiyon
                        ...
                        <>
                          <div className="mb-4 background-3 neutral-500" style={{ borderRadius: "3px", padding: "20px" }}>
                            ...
                            <div className="neutral-500">
                              📆 {formatDate(bookingData.tourDate)} / {bookingData.chosenTourStartTime}
                            </div>
                            <div className="neutral-500">
                  ...
                  <div className="col-12 col-md-8">
                    ...
                    <div>
                      <button
                        ...
                        disabled={paymentIsLoading || isSubmitting}
                      >
                        {paymentIsLoading ? t("islemYapiliyor") : t("he")}
                      </button>
                    </div>
            ...
            <section className="background-body py-8 mt-20">
              <div className="container max-w-6xl mx-auto px-4">
                <div className="row">
                  <div className="col-12 col-md-8">
                    <div className="card p-4">
                      <h5 className="text-center mb-4">{t("25")}</h5>
                      <p className="mb-4">
                        {t("yuzde25")}
                      </p>
                      ...
                      >
                        {paymentIsLoading ? t("islemYapiliyor") : t("25")}
                      </button>
                    </div>
                  </div>
                      ...
                      {loading ? (
                        ...
                        <>
                          ...
                          <p className="text-center text-success">
                            {t("odenecek25")} ${(bookingData.totalPrice * 0.25).toFixed(2)}
                          </p>
                        </>
                      ) : (
                        <div className="text-center py-4">
            ...
            <section className="background-body py-8 mt-20">
              <div className="container max-w-6xl mx-auto px-4">
                <div className="row">
                  <div className="col-12 col-md-8">
                    <div className="card p-4">
                      <h5 className="text-center mb-4">{t("tour")}</h5>
                      <p className="mb-4">
                        {t("turdaOde")}
                      </p>
                      ...
                      >
                        {paymentIsLoading ? t("islemYapiliyor") : t("tour")}
                      </button>
                    </div>
                  </div>
              ...
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title">{t("Ödeme Onayı")}</h5>
                    <button
                      type="button"
                      className="btn-close"
                  ...
                  <div className="modal-body">
                    <p>{t("devamEt")}</p>
                    <p className="font-weight-bold text-success">{t("bankaOnay")}</p>
                  </div>
                  <div className="modal-footer">
                    ...
                    >
                      {paymentIsLoading ? t("islemYapiliyor") : t("Devam Et")}
                    </button>
                  </div>
                </div>
              </div>
