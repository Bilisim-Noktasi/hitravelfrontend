					...
					<section className="box-section box-breadcrumb">
						<div className="container">
							<ul className="breadcrumbs">
								...
								<li> <span className="text-breadcrumb">{t("hakkımızda")}</span></li>
							</ul>
						</div>
					</section>
						...
						<div className="container">
							<div className="row align-items-end">
								<div className="col-lg-7 wow fadeInUp"> 
									<h1 className="neutral-1000 mt-0 mb-15">
										<span>{t("Neden")}</span> {t("hitravel")}?</h1>
									
								</div>
								<div className="col-lg-5">
									<div className="box-icon-flight"><img src="/assets/imgs/page/pages/flight.png" alt="Travile" />
										<h6 className="neutral-1000">{t("mission")}</h6>
									</div>
								</div>
							</div>
						</div>
					...
					<section className="section-box box-why-book-travila-5 background-5">
						<div className="container">
							<div className="row align-items-center">
								<div className="col-lg-6 mb-30"><span className="btn btn-brand-secondary background-0 wow fadeInUp"> <img className="mr-10" src="/assets/imgs/page/homepage4/earth.svg" alt="Travile" />{t("nedenHi")}</span>
									<h2 className="mt-15 mb-15 neutral-1000 wow fadeInUp">{t("amac")}</h2>
									<div className="list-numbers wow fadeInUp">
										<div className="item-number">
											<h3 className="neutral-1000">30+</h3>
											<p className="text-lg-bold neutral-500">{t("guven")}</p>
										</div>
										<div className="item-number">
											<h3 className="neutral-1000">100+</h3>
											<p className="text-lg-bold neutral-500">{t("yurt")}</p>
										</div>
										<div className="item-number">
											<h3 className="neutral-1000">20+</h3>
											<p className="text-lg-bold neutral-500">{t("yıl")}</p>
										</div>
										<div className="item-number">
											<h3 className="neutral-1000">100K</h3>
											<p className="text-lg-bold neutral-500">{t("mutlu")}</p>
										</div>
									</div>
								</div>
									...
									<div className="row">
										<div className="col-lg-6 col-sm-6 pt-30">
											<div className="card-why card-why-2 background-1 wow fadeInUp">
												...
												<div className="card-info">
													<h6 className="text-xl-bold neutral-1000">300,000+ {t("deneyim")}</h6>
													<p className="text-lg-medium neutral-500">{t("anı")}</p>
												</div>
											</div>
											<div className="card-why card-why-2 background-3 wow fadeInUp">
												...
												<div className="card-info">
													<h6 className="text-xl-bold neutral-1000">{t("rez")}</h6>
													<p className="text-lg-medium neutral-500">{t("simdi")}</p>
												</div>
											</div>
										</div>
										<div className="col-lg-6 col-sm-6">
											<div className="card-why card-why-2 background-2 wow fadeInUp">
												...
												<div className="card-info">
													<h6 className="text-xl-bold neutral-1000">{t("mutlu")}</h6>
													<p className="text-lg-medium neutral-500">{t("yuz")}</p>
												</div>
											</div>
											<div className="card-why card-why-2 background-4 wow fadeInUp">
												...
												<div className="card-info">
													<h6 className="text-xl-bold neutral-1000">{t("hi")}</h6>
													<p className="text-lg-medium neutral-500">{t("güven")}</p>
												</div>
											</div>
										</div>
									</div>
