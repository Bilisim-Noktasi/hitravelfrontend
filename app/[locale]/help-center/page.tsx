    ...
    <>
      <Layout headerStyle={1} footerStyle={1}>
        <main className="main">
          <section className="box-section box-breadcrumb">
            <div className="container">
              <ul className="breadcrumbs">
                ...
                <li>
                  {" "}
                  <span className="text-breadcrumb">{t("help")}</span>
                </li>
              </ul>
            </div>
          </section>
          <section className="box-section box-location-shop-2 background-body">
            <div className="container">
              <div className="row align-items-end">
                <div className="col-lg-7 wow fadeInUp">
                  ...
                  <p className="text-xl-medium neutral-500">{t("title")}</p>
                </div>
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        {" "}
                        <Link className="title text-lg-bold" href="/tours">
                          {t("rez")}
                        </Link>
                        <p className="text-xs-medium neutral-500">{t("1")}</p>
                      </div>
                      <div className="card-method-contact">
                        {" "}
                        <Link className="email text-md-bold" href="/tours">
                          {t("detay")}
                          <svg
                            width={16}
                            height={16}
                ...
                <div className="col-lg-3 col-sm-6">
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        {" "}
                        <Link className="title text-lg-bold" href="/contact">
                          {t("iş")}
                        </Link>
                        <p className="text-xs-medium neutral-500">{t("2")}</p>
                      </div>
                      <div className="card-method-contact">
                        {" "}
                        <Link className="email text-md-bold" href="/contact">
                          {t("detay")}
                          <svg
                            width={16}
                            height={16}
                ...
                <div className="col-lg-3 col-sm-6">
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        {" "}
                        <Link className="title text-lg-bold" href="/activity">
                          {t("Faaliyet")}
                        </Link>
                        <p className="text-xs-medium neutral-500">{t("3")}</p>
                      </div>
                      <div className="card-method-contact">
                        {" "}
                        <Link className="email text-md-bold" href="/activity">
                          {t("detay")}
                          <svg
                            width={16}
                            height={16}
                ...
                <div className="col-lg-3 col-sm-6">
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        {" "}
                        <Link className="title text-lg-bold" href="/refund">
                          {t("iptal")}
                        </Link>
                        <p className="text-xs-medium neutral-500">{t("4")}</p>
                      </div>
                      <div className="card-method-contact">
                        {" "}
                        <Link className="email text-md-bold" href="/refund">
                          {t("detay")}
                          <svg
                            width={16}
                            height={16}
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        ...
                        <p className="text-xs-medium neutral-500">{t("5")}</p>
                      </div>
                      <div className="card-method-contact">
                        {" "}
                        <Link className="email text-md-bold" href="/contact">
                ...
                <div className="col-lg-3 col-sm-6">
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        {" "}
                        <Link className="title text-lg-bold" href="/privacy">
                          {t("emniyet")}
                        </Link>
                        <p className="text-xs-medium neutral-500">{t("6")}</p>
                      </div>
                      <div className="card-method-contact">
                        {" "}
                        <Link className="email text-md-bold" href="/privacy">
                          {t("detay")}
                          <svg
                            width={16}
                            height={16}
          ...
          <section
            className="box-section box-contact-form box-contact-form-2 background-body"
            id="contact-form"
          >
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-6">
                  <h2 className="neutral-1000 mb-25">{t("con")}</h2>
