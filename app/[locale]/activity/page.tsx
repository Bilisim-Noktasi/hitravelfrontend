              ...
              <ul className="breadcrumbs">
                ...
                <li>
                  ...
                  <span className="text-breadcrumb">
                    Hi Travel Faaliyetleri Nelerdir?{" "}
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="container">
              ...
              <div className="box-mw-824">
                <div className="box-detail-info">
                  <p>{t("intro")}</p>
                  <p>
                    <strong>1. {t("title")}:</strong> {t("desc")}
                  </p>
                  <p>
                    <strong>2. {t("titl2")}:</strong> {t("desc2")}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>6. {t("title6")}:</strong> {t("desc6")}
                  </p>
                ...
                <div className="box-share-us">
                  <p className="text-lg-medium neutral-900">Saygılarımızla. </p>
                  <p className="text-lg-bold neutral-1000">Hi Travel Ekibi </p>
                </div>
              </div>
            </div>
          </section>
